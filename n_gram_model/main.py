from utils import (
    create_corpus,
    create_unigram_counts,
    create_bigram_counts,
    compute_unsmoothed_unigram,
    compute_unsmoothed_bigram,
    print_type_token_counts,
    print_corpus,
)
...
def main():
    ...
    is_compute_unigram = (
        input("Do you want to compute unsmoothed unigram? [y/n]: ").strip() == "y"
    )
    ...
    is_compute_bigram = (
        input("Do you want to compute unsmoothed bigram? [y/n]: ").strip() == "y"
    )
    if is_compute_bigram:
        ...
        p = compute_unsmoothed_bigram(
            unigram_counts=unigram_counts,
            bigram_counts=bigram_counts,
            token_lst=bi_token_lst,
        )
